...
const SearchResultItem = ({ item, viewMode, handleItemClick }) => {
    ...
    return (
        <div className="h-14 flex border-b border-border" onClick={() => handleItemClick(item.id)}>
            ...
            <p className='flex-1 flex items-center text-base font-semibold truncate'>{item.name}</p>

            <p className='w-32 flex items-center justify-center text-sm text-center'>07-07-2024 17:20</p>
